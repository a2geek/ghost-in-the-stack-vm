...
| `GLOBAL_ILOADB`  |   2    | Indirect load byte from address in global variable to TOS.                                                                                                                                                    |
| `GLOBAL_ILOADW`  |   2    | Indirect load word from address in global variable to TOS.                                                                                                                                                    |
| `GLOBAL_ISTOREB` |   2    | Indirect store byte from address in global variable to TOS.                                                                                                                                                   |
| `GLOBAL_ISTOREW` |   2    | Indirect store word from address in global variable to TOS.                                                                                                                                                   |
...
| `LOCAL_ILOADB`   |   2    | Indirect load byte from address in local variable to TOS.                                                                                                                                                     |
| `LOCAL_ILOADW`   |   2    | Indirect load word from address in local variable to TOS.                                                                                                                                                     |
| `LOCAL_ISTOREB`  |   2    | Indirect store byte from address in local variable to TOS.                                                                                                                                                    |
| `LOCAL_ISTOREW`  |   2    | Indirect store word from address in local variable to TOS.                                                                                                                                                    |
